...
export const coreConfig: CoreConfig = {
  app: {
    appName     : 'Customer Portal',                                        // App Name
    appTitle    : 'Customer Portal', // App Title
    appLogoImage: 'assets/images/logo/logo-avr.png',                  // App Logo
    appLanguage : 'id',                                           // App Default Language (en, fr, de, pt etc..)
  },
  layout: {
